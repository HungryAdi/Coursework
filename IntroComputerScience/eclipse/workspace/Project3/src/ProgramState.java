...
public class ProgramState
{
	...
	public void endReached () {
		this.programCounter=this.statements.size();
	}
	
	public boolean hasStatementsToExecute() {
		if (this.statements == null || this.statements.size() <= 1 ) {
			return false;
		}
	...
	public void setGoToLineNumber(int lineNumber) {
		this.programCounter = (lineNumber);
	}

	
	public void setStatements (ArrayList<Statement> statements) {
		this.statements.add(new NullStatement());
